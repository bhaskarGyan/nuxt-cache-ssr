/* Following regex originated from Nuxt device module 
...
function isMobile(a: string): boolean {
...
function getBrowserName(a: string): string {
...
export default function generateFlags(headers, userAgent): Device {
    let mobile = false
